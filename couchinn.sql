...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2016 a las 01:03:56
...
--
-- Estructura de tabla para la tabla `califhost`
--

CREATE TABLE IF NOT EXISTS `califhost` (
  `idcalif_host` int(11) NOT NULL,
  `idreserva` int(11) NOT NULL,
  `puntajehost` tinyint(2) NOT NULL,
  `commenthost` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `califhuesped`
--

CREATE TABLE IF NOT EXISTS `califhuesped` (
  `idcalif_hues` int(11) NOT NULL,
  `idreserva` int(11) NOT NULL,
  `puntajehues` tinyint(2) NOT NULL,
  `commenthues` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `couchs` (`idcouch`, `iduser`, `idtipo`, `cod_loc`, `nombrecouch`, `capacidad`, `visibilidad`) VALUES
(1, 2, 2, 1, 'Habitación con cama tipo cucheta.', 2, 0),
(2, 3, 1, 14, 'Carpa en patio cerrado para alojar visitantes.', 1, 0),
(3, 3, 2, 25, 'habitación extra en casa en zona residencial para alojar visitantes', 2, 0),
(4, 2, 2, 40, 'cama extra en habitación para compartir con visitantes', 1, 0),
(5, 1, 2, 63, 'casa frente al parque con una habitación disponible para alojamiento', 3, 0),
(6, 3, 2, 71, 'cabaña con una habitacion para compartir', 1, 0),
(7, 1, 2, 22, 'COUCH NO VISIBLE DE PRUEBA', 2, 0),
(8, 1, 3, 1000, 'sofa en comedor para visitas', 1, 0),
(9, 2, 4, 553, 'cama doble para visitas', 2, 0),
(10, 2, 4, 802, 'cama kladjae hefiwehfwef fwef', 1, 0),
(11, 3, 3, 768, 'sofa kaldflsd sdjfnsjfn sdhfnsj', 1, 0),
(12, 3, 2, 1360, 'habitacion jadhfjas sjdfhiehf', 3, 0),
(13, 1, 1, 1999, 'carpa osdjfks sdfnsiofnsd', 3, 0),
(14, 2, 1, 2008, 'carpa en patio con bosque', 4, 0),
(15, 1, 4, 2370, 'camas en cabaña en habitacines compartidas', 5, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `imgcouchs`
--

CREATE TABLE IF NOT EXISTS `imgcouchs` (
...
INSERT INTO `localidades` (`cod_loc`, `cod_prov`, `nombreloc`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
INSERT INTO `pagos` (`idpago`, `iduser`, `fechapago`, `monto`) VALUES
(1, 3, '2016-05-01 00:00:00', '10.00');
...
INSERT INTO `provincias` (`cod_prov`, `nombreprov`) VALUES
(1, 'Buenos Aires'),
(2, 'Buenos Aires-GBA'),
(3, 'Capital Federal'),
(4, 'Catamarca'),
...
CREATE TABLE IF NOT EXISTS `reservas` (
  ...
  `estado` enum('aceptada','cancelada','concretada','pendiente') NOT NULL
...
INSERT INTO `reservas` (`idreserva`, `idcouch`, `iduser`, `fechaini`, `fechafin`, `estado`) VALUES
(1, 6, 2, '2016-06-09', '2016-06-14', 'pendiente'),
(2, 1, 3, '2016-05-03', '2016-05-07', 'concretada'),
(3, 1, 3, '2016-07-01', '2016-07-03', 'aceptada');
...
INSERT INTO `tipocouch` (`idtipo`, `nombretipo`, `bajalogica`) VALUES
(1, 'carpa', 0),
(2, 'habitacion', 0),
(3, 'sofa', 0),
(4, 'cama', 0);
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `bio` text,
  `fotouser` varchar(45) DEFAULT NULL,
...
INSERT INTO `usuarios` (`iduser`, `email`, `pass`, `nombre`, `apellido`, `fechanac`, `nacionalidad`, `telefono`, `bio`, `fotouser`, `admin`, `premium`) VALUES
(1, 'admin@admin.com', 'admin', 'administrador', 'administrador', '1992-01-01', 'argentina', '0221333333', 'administrador de prueba', NULL, 1, 1),
(2, 'user@user.com', 'user', 'usuario', 'estandar', '1990-12-17', 'argentino', '02214557', 'usuario estandar', NULL, 0, 0),
(3, 'premium@premium.com', 'premium', 'premium', 'vip', '1980-10-10', 'argentino', '11598233', 'usuario premium', NULL, 0, 1);
...
--
-- Indices de la tabla `califhost`
--
ALTER TABLE `califhost`
  ADD PRIMARY KEY (`idcalif_host`);

--
-- Indices de la tabla `califhuesped`
--
ALTER TABLE `califhuesped`
  ADD PRIMARY KEY (`idcalif_hues`);
...
--
-- Indices de la tabla `imgcouchs`
--
ALTER TABLE `imgcouchs`
...
--
-- AUTO_INCREMENT de la tabla `califhost`
--
ALTER TABLE `califhost`
  MODIFY `idcalif_host` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `califhuesped`
--
ALTER TABLE `califhuesped`
  MODIFY `idcalif_hues` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `couchs`
  MODIFY `idcouch` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT de la tabla `imgcouchs`
--
ALTER TABLE `imgcouchs`
...
--
ALTER TABLE `localidades`
  MODIFY `cod_loc` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2383;
--
...
--
ALTER TABLE `provincias`
  MODIFY `cod_prov` int(2) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
